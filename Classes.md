...
As an **action**, you can expend a use of Channel Divinity to regain a **level 1 spell slot**. You can do this once per long rest at level 2, twice per long rest at level 6, and three times per long rest at level 18. *(From TCE, but slower and the spell level doesn't scale)*
...
**Channel Divinity: Guided Strike (lvl 2):** Alternatively, you can give this benefit to a creature within 30 feet of you if you also use your reaction.  *(From 2024; basically, you can also use the old War God's Blessing here too.)*
...
These are also available replacements (although I personally prefer my improvements to the original version below): 
...
* You do not gain a spell based on your affinity.
...
##### Origin: Wild Magic
You (rather than the DM) can choose whether to roll the Wild Magic Surge d20 or rolling on the on the Wild Magic Surge table to recover your use of Tides of Chaos. You cannot use metamagic on spells you casts from the Wild Mage table. *(From 2024)*
...
When you gain access to a new bonus spell known through this means, randomly select a sorcerer spell of that spell level.  If this produces a spell you already know, roll again.

Each time you level up, you can choose to regenerate your full list of bonus spells known. Randomly select a new sorcerer spell for each bonus spell level that you have.
...
##### Patron: Hexblade
**Disallowed.**  *(The Hexblade lacks good flavor, and iit s regularly abused for small Warlock dips. Given the change to Pact of the Blade above to capture the essence of a martial warlock, there is less value to this subclass. If you have a good story reason for this patron, we can talk.)*
